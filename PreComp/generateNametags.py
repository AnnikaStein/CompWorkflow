...
util.compilePdflatex(compID, f'labels-{compID}-frontsides.tex', cleanUp = True)
print(f'>> Compiling back sides.')
util.compilePdflatex(compID, f'labels-{compID}-backsides.tex', cleanUp = True)
print(f'>> Compiling merged pdf.')
util.compilePdflatex(compID, f'labels-{compID}-merged.tex', cleanUp = True)
print()
print()
print(f'>> Nametag tex files for {compName} successfully saved.')
print()
